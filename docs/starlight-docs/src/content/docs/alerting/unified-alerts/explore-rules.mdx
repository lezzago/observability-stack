...
**Disable** stops a rule from evaluating at all. To keep a metric rule running but stop its *notifications* temporarily, use an Alertmanager **silence** instead — see [Notification Channels](/docs/alerting/unified-alerts/notifications/#metric-rule-notifications-alertmanager).
</Aside>
